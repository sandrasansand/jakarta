  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-4">
      <select name="pais" id="pais" class="form-select">
        ...
        <option value="MX" ${param.pais.equals("PO")? "selected": ""}>Portugal</option>
        <option value="CL" ${param.pais.equals("FR")? "selected": ""}>Francia</option>
        <option value="AR" ${param.pais.equals("IT")? "selected": ""}>Italia</option>
        <option value="PE" ${param.pais.equals("AL")? "selected": ""}>Alemania</option>
        <option value="CO" ${param.pais.equals("SU")? "selected": ""}>Suecia</option>
        <option value="VE" ${param.pais.equals("FI")? "selected": ""}>Finlandia</option>
      </select>
    </div>
    <%
