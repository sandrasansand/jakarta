...
<c:if test="${username.present}">
   <div class="alert alert-info">Hola ${username.get()}, bienvenidX!</div>
...
<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <c:if test="${username.present}">
        <td>${p.precio}</td>
        <td><a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/carro/agregar?id=${p.id}">añadir</a></td>
